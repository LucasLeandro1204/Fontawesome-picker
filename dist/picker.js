...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__core_box__ = __webpack_require__(1);
...
var Picker = function () {
  function Picker() {
    ...
    this.box = __WEBPACK_IMPORTED_MODULE_0__core_box__["a" /* default */].init(target, this._onpick);
    this._setup();
  }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__resources_fontawesome_icons_json__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__resources_fontawesome_icons_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__resources_fontawesome_icons_json__);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Box = function () {
  ...
  _createClass(Box, [{
    ...
    value: function _render() {
      return Object.keys(__WEBPACK_IMPORTED_MODULE_0__resources_fontawesome_icons_json___default.a).map(function (key) {
        return __WEBPACK_IMPORTED_MODULE_0__resources_fontawesome_icons_json___default.a[key].map(function (icon) {
          return '<i class="' + icon + ' box-icon"></i>';
        }).join('');
      }).join('');
    }
  }, {
